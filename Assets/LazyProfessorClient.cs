...
public class LazyProfessorClient : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C))
            SendMessageToHost(ClientToServerTransferSignifiers.CreateAccount + ",101234068,00000000");

        else if (Input.GetKeyDown(KeyCode.L))
            SendMessageToHost(ClientToServerTransferSignifiers.Login + ",101234068,00000000");
            ...
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitDiscordUserName + ",danhc#6437");
